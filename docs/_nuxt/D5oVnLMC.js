import{_ as f,a as u}from"./DXHoEFTA.js";import{_ as g}from"./BtIylxeA.js";import{i as b,g as v,o as c,c as p,b as t,w as o,a as e,d as s,h as y,p as x,e as k,_ as m,F as w}from"./DAmhm2ud.js";import"./C1v8UIkE.js";import"./Dg_zS6C8.js";const T=b("/images/data_csv_sample.png"),a=r=>(x("data-v-21afd141"),r=r(),k(),r),z={class:"inner pt-10"},E=a(()=>e("h3",null,"Finetuning TurkishBERTweet for Text Classification Using LoRA",-1)),R=a(()=>e("p",null,"In this section, we will guide you through the process of finetuning TurkishBERTweet on your own data form text Classification. ",-1)),L=a(()=>e("h3",null,"Setting Up the Environment for TurkishBERTweet",-1)),B=a(()=>e("br",null,null,-1)),C=a(()=>e("br",null,null,-1)),S=a(()=>e("h5",null,"1. Clone the Repository: Begin by cloning the TurkishBERTweet repository from GitHub.",-1)),q=a(()=>e("h5",null,"2. Navigate to the Directory: Move into the newly cloned directory.",-1)),A=a(()=>e("h5",null,"3. Set Up a Virtual Environment: Create a virtual environment to manage dependencies.",-1)),F=a(()=>e("h5",null,"4. Activate the Virtual Environment: Activate the virtual environment.",-1)),j=a(()=>e("h5",null,"5. Install Required Libraries: Install PyTorch and other essential libraries to run TurkishBERTweet. ",-1)),I=a(()=>e("h5",null,"6. Preparing your dataset for finetuning:",-1)),D=a(()=>e("p",null," Let's assume that you have a CSV file containing your samples with its corresponding labels. ",-1)),N=a(()=>e("div",{class:"border-border border p-2 rounded-md image_center"},[e("img",{src:T,alt:"Sample Image"})],-1)),M=a(()=>e("br",null,null,-1)),P=a(()=>e("p",null,[s(" I recommend converting your dataset into a HuggingFace dataset using "),e("a",{href:"https://huggingface.co/docs/datasets/en/index",class:"specialfont menu"},"datasets"),s(" library. To do so use the following script. Here I assume that you haven't split your data into train and test sets. ")],-1)),V=a(()=>e("p",null,[s(" Now in your output directory, you will see "),e("span",{class:"specialfont"},"custom_ds"),s(" directory containing your data. ")],-1)),H=a(()=>e("h5",null,"7. It is time to finetune TurkishBERTweet with LoRA",-1)),U=a(()=>e("p",null,"First you need to prepare the config file in which you will set the training parameters and dataset paths, etc.",-1)),O=a(()=>e("p",null,"Then you will run the following script passing the config file.",-1)),W=a(()=>e("br",null,null,-1)),$="git clone git@github.com:ViralLab/TurkishBERTweet.git",G="cd TurkishBERTweet",K="python -m venv venv",Q=`# Need to mention that here Cuda 11.8 is being installed. Check whether your GPU Spec and install the compatible cuda.
...
`,Z="python finetune.py path/config.json ",ee=v({__name:"FinetuneMain",setup(r){const l=String.raw`#Linux/Mac users
source venv/bin/activate
# Windows users
.\venv\Scripts\activate
`;return(_,d)=>{const n=g,i=y,h=f;return c(),p("main",z,[t(h,null,{default:o(()=>[e("div",null,[E,R,L,s(" To begin using the TurkishBERTweet model for sentiment analysis, you'll first need to set up your development environment. This involves cloning the TurkishBERTweet repository, creating a virtual environment, and installing the necessary libraries. Follow these steps to get started: "),B,C,S,t(i,null,{default:o(()=>[t(n,{code:$,language:"bash",filename:"clone.sh"})]),_:1}),q,t(i,null,{default:o(()=>[t(n,{code:G,language:"bash",filename:"cd.sh"})]),_:1}),A,t(i,null,{default:o(()=>[t(n,{code:K,language:"bash",filename:"venv.sh"})]),_:1}),F,t(i,null,{default:o(()=>[t(n,{code:l,language:"bash",filename:"activate.sh"})]),_:1}),j,t(i,null,{default:o(()=>[t(n,{code:Q,language:"text",filename:"install.sh"})]),_:1}),I,D,N,M,P,t(i,null,{default:o(()=>[t(n,{code:X,language:"python",filename:"create_dataset.py"})]),_:1}),V,H,U,t(i,null,{default:o(()=>[t(n,{code:J,language:"json",filename:"config.json"})]),_:1}),O,t(i,null,{default:o(()=>[t(n,{code:Z,language:"bash",filename:"run_finetune.sh"})]),_:1}),t(i,null,{default:o(()=>[t(n,{code:Y,language:"python",filename:"finetune.py"})]),_:1})]),W]),_:1})])}}}),te=m(ee,[["__scopeId","data-v-21afd141"]]),ae={};function oe(r,l){const _=u,d=te;return c(),p(w,null,[t(_,{title:"Finetune TurkishBERTweet Using LoRA"}),t(d)],64)}const _e=m(ae,[["render",oe]]);export{_e as default};
